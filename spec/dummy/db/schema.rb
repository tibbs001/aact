...
ActiveRecord::Schema.define(version: 20150629193710) do
  ...
  create_table "data_definitions", force: :cascade do |t|
    t.string "aact_column",    limit: 255
    t.string "aact_table",     limit: 255
    ...
    t.string "nlm_definition", limit: 255
    t.string "ctti_notes",     limit: 255
  ...
  create_table "eligibilities", force: :cascade do |t|
    ...
    t.string "study_population",   limit: 255
